...
const TableItemStack = ({ stackSizeName, stackClass }: Stack) => (
  ...
  <div className={`${stackClass}-stack-wrapper`}>
    <div className="stack-inner-wrapper">
      ...
      { stackSizeName >= 16000 ? <img className="player-stack-7" src={stack} alt="Chip stack" /> : null }
      { stackSizeName >= 32000 ? <img className="player-stack-8" src={stack} alt="Chip stack" /> : null }
    </div>
  </div>
);
